...
from reid import load_transreid_config, build_transreid_model, extract_transreid_features
...
cfg_path = "reid_trans/TransReID/configs/msmt17/vit_small_ics.yml"
pretrained_path = "reid_trans/TransReID/pretrain/vit_small_ics_cfs_lup.pth"
cfg = load_transreid_config(cfg_path, pretrained_path)
reid_model = build_transreid_model(cfg)
...
try:
    while True:
        ...
        for i, frame in enumerate(frames):
            ...
            if detections:
                features = [extract_transreid_features(reid_model, cfg, frame[y1:y2, x1:x2])
